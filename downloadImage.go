...
func main() {
	...
	//file, _ := os.OpenFile("D:\\Downloads\\file.txt", os.O_RDONLY, 6)
	file, _ := os.OpenFile("/Users/xiexingan/Downloads/file.txt", os.O_RDONLY, 6)
	defer func() {
	...
	for _, ss := range submatch {
		...
		urlstring := "https://lypaslx.ehedgzdwvjcc.hath.network:11759/h/" + fileid + "/keystamp=" + keystampTime + "-" + fmt.Sprintf("%x", sum)[0:10] + ";fileindex=" + fileindex + ";xres=org/" + split[0] + "." + split[4]
